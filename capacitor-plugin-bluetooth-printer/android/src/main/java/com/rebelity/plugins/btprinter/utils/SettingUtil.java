...
public class SettingUtil {
    private static com.rebelity.plugins.btprinter.utils.SettingUtil instance;
    ...
    private String[]        barcodeEncodings = new String[]{"UPC-A", "UPC-E", "EAN13", "EAN8", "CODE39", "ITF", "CODABAR"};
    ...
    private final int           DEFAULT_STRING_ENCODING_INDEX = 8;
    private final int           DEFAULT_HRI_POSITION = HRI_POSITION_BARCODE_DOWN;

    private final int           DEFAULT_BARCODE_ENCODING_INDEX = 4;

    public SettingUtil() {
        this.instance = this;
    }

    public static com.rebelity.plugins.btprinter.utils.SettingUtil getInstance() {
        return instance;
    }
