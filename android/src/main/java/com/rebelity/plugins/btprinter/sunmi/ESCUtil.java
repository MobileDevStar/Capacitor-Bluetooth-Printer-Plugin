package com.rebelity.plugins.btprinter.sunmi;
...
public class ESCUtil {
	...
	public static byte[] getPrintQRCode2(String data, int size){
		...
		byte[] bytes2 = com.rebelity.plugins.btprinter.sunmi.BytesUtil.getZXingQRCode(data, size);
		return com.rebelity.plugins.btprinter.sunmi.BytesUtil.byteMerger(bytes1, bytes2);
	}
	...
	public static byte[] getPrintBarCode(String data, int symbology, int height, int width, int textposition){
		...
		try{
			...
			byte[] barcode;
			if(symbology == 10){
				barcode = com.rebelity.plugins.btprinter.sunmi.BytesUtil.getBytesFromDecString(data);
			}else{
	...
	public static byte[] printBitmap(Bitmap bitmap){
		...
		byte[] bytes2 = com.rebelity.plugins.btprinter.sunmi.BytesUtil.getBytesFromBitMap(bitmap);
		return com.rebelity.plugins.btprinter.sunmi.BytesUtil.byteMerger(bytes1, bytes2);
	}
	...
	public static byte[] printBitmap(byte[] bytes){
		...
		return com.rebelity.plugins.btprinter.sunmi.BytesUtil.byteMerger(bytes1, bytes);
	}
	...
	public static byte[] selectBitmap(Bitmap bitmap, int mode){
		return com.rebelity.plugins.btprinter.sunmi.BytesUtil.byteMerger(com.rebelity.plugins.btprinter.sunmi.BytesUtil.byteMerger(new byte[]{0x1B, 0x33, 0x00}, com.rebelity.plugins.btprinter.sunmi.BytesUtil.getBytesFromBitMap(bitmap, mode)), new byte[]{0x0A, 0x1B, 0x32});
	}
	...
	// open cash drawer
	public static byte[] openGenericCasheDrawer(){
		byte[] data = new byte[]{0x1B, 0x70, 0x00, 0x19, (byte)0xFA};
		return data;
	}
